...
async function LeftSidebar() {
  ...
  return (
    <section className="flex h-full flex-col justify-between overflow-y-auto no-scrollbar border-r border-gray-800/70 bg-white/90 p-5 max-sm:p-2 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/70 dark:bg-slate-950/85 dark:shadow-none max-sm:hidden">
      <div className="h-full flex flex-col justify-between">
        <div className="flex flex-1 flex-col gap-3 max-sm:gap-2">
        ...
        <div>
              ...
              <>
                <form action={
                  ...
                  <button type="submit" className="text-gray-800 dark:text-gray-300">Log out</button>
                </form>
              </>
              :
              <>
